...
function createDiv (array) {
    ...
    for (const arrayElement of array) {
        document.write(`<div>${arrayElement.id}. ${arrayElement.name} - ${arrayElement.username}.</div>`)
    }
    document.write(`</div>`);
}
createDiv(usersList);
